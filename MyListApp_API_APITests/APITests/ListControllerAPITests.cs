...
public class ListControllerAPITests
{
    ...
    {
        var userId = new Guid("2cf4e09e-7858-40be-8e26-569117928bed");
        var updateUserListDto = new UpdateUserListDto { NewTitle = "Ny List Titel", UserId = userId, UserListId = new Guid("c3a9e351-ed6b-4d36-84c0-7d29af59ad1b") };
    ...
    public void DeleteUserList_ShouldDeleteUserList_ReturnOkMessage()
    {
        ...
        var userListId = new Guid("a2e4b812-3429-4e2a-9187-516c07a51d87");
    ...
    {
        //Arrange
        var request = new RestRequest("List/GetAllUserLists", Method.Get);
